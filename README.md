...
- [Free Support](https://app-generator.dev/ticket/create/?generated_repo=https://github.com/app-generator/django-adminlte-1740809036) via `eMail` and `Discord`
...
```bash
$ git clone https://github.com/django-adminlte-1740809036.git
$ cd django-adminlte-1740809036
```
